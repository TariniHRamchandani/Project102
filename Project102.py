...
#in this program we are making a program that will help us calculate different problems instead of using our phones etc

#we import math and sys

#we add the variable and assign them values
